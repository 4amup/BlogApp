...
import org.apache.commons.io.FileUtils; //这里引入了一个外部包，作用和python中的anaconda一样
...
public class PostRepositoryByList implements PostRepository {
    ...
    public static PostRepository instance() {
        ...
        if (postRepository == null) {
            postRepository = new com.tianmaying.PostRepositoryByList();
        }
    ...
    public void saveData() throws BlogAppException {
        for (Post post : com.tianmaying.PostRepositoryByList.instance().getAll()) {
